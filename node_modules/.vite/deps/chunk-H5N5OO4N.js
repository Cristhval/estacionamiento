...
function getSpringCsrfTokenParametersForAuthRequest(doc) {
  const csrfInfo = getSpringCsrfInfo(doc);
  const parameters = {};
...
async function doLogout(doc, options) {
  const shouldSubmitFormLogout = !(options == null ? void 0 : options.navigate) && !(options == null ? void 0 : options.onSuccess);
...
*/
//# sourceMappingURL=chunk-H5N5OO4N.js.map
